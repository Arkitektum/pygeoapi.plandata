...
RUN \
    ...
    && uv pip install --constraint /tmp/constraints.txt git+https://github.com/Arkitektum/pygeoapi.provider.postgresql_ext@v0.5.2 \
    ...
    && uv pip install --constraint /tmp/constraints.txt git+https://github.com/Arkitektum/pygeoapi.formatter.gml-npad@v0.5.0 \
